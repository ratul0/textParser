    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            try {
                ...
                SqlRead = "SELECT id, link, status FROM economics where status = 0";
                SqlUpdate = "update economics set status=1 where id=?";
                ...
                while(rs.next()){
                    ...
                    try {
                        bw = new BufferedWriter(new FileWriter(new File("dataset/economics/link" + id + ".txt"), false));
